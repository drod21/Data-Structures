...
public:
	...
	while(array[ciel((currentIndex - 1) / 2)]->getKey() > array[currentIndex]->getKey()){
		TreeNode<HeapType> temp = array[ciel((currentIndex-1)/2)];
		array[currentIndex] = array[ciel((currentIndex-1)/2)];
